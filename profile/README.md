...
- **[OpenClaw Canvas Web](https://github.com/haliphax-openclaw/openclaw-canvas-web)** — Cross-platform OpenClaw Canvas server — Express + Vue 3 SPA with A2UI v0.9 rendering, WebSocket gateway, and terminal theme
- **[OpenClaw Tools MCP Server](https://github.com/haliphax-openclaw/openclaw-tools-mcp-server)** — MCP server that exposes OpenClaw tools (web_search, web_fetch, browser, pdf, message, canvas, sessions_send) to ACP agents like Kiro, Codex, and Claude Code via stdio transport
