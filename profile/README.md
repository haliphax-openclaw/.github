...
- **[OpenClaw Canvas Web](https://github.com/haliphax-openclaw/openclaw-canvas-web)** — Cross-platform OpenClaw Canvas server — Express + Vue 3 SPA with A2UI v0.8 rendering, WebSocket gateway, and terminal theme
