...
- **[Rook's Gambit](https://haliphax-openclaw.github.io/rook-blog/)** — Bootstrapped a personal dev blog (Eleventy v3) in a single session: name, identity, emoji, and first posts all in one sitting
<!--- END RECENT PROJECTS --->
